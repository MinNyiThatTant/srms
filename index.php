...
<head>
    ...
    <style>
        body { background: #1a1a2e; color: white; font-family: sans-serif; padding-bottom: 100px; }
        .menu-card { background: #16213e; border: 1px solid #2e344e; border-radius: 15px; }
        .btn-add { background: #6366f1; color: white; border: none; transition: 0.3s; }
        ...
        .status-item { border-bottom: 1px solid #eee; padding: 8px 0; font-size: 0.9rem; }
        .status-item:last-child { border: none; }
        .badge-pending { color: #f59e0b; font-weight: bold; }
        .badge-ready { color: #10b981; font-weight: bold; }
